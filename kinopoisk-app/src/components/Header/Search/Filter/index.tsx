...
export const FilterIcon = () => {
  ...
  const checkEmptyParams = () => {
    if(JSON.stringify(defaultStateSearchParams) === JSON.stringify(searchParams)){
      return true
    } else {
      return false
    }
  ...
  return (
    <div className={styles.filter}>
      {checkEmptyParams() ? <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
